...
import resume from '../assets/mdramjanmiaresume.pdf'
...
const Menubar = () => {
  ...
  return (
    <header className="relative w-full min-h-[100vh] lg:h-[100vh] flex flex-col animated-gradient overflow-hidden">
      <Container>
        <nav className="relative z-20 flex items-center justify-between py-6 mr-[261px]">
          ...
          <div className="md:hidden">
            <button
              ...
              className="text-white z-30 relative w-8 h-8 focus:outline-none left-[130px]"
            >
            ...
            <div className="w-full lg:w-[60%] flex flex-col justify-center items-center lg:items-start text-white">
              ...
              <motion.div variants={itemVariants}>
                <Flex className="text-3xl sm:text-4xl text-secondary items-center gap-x-6 my-8 cursor-pointer justify-center lg:justify-start">
                  <a href="https://www.facebook.com/mdramjan.mia.3" aria-label="Facebook" className="hover:text-cyan-400 transition-colors" target="_blank"><CiFacebook /></a>
                  <a href="https://www.linkedin.com/in/mohammad-ramjan-mia-667305277/" aria-label="LinkedIn" className="hover:text-cyan-400 transition-colors" target="_blank"><TiSocialLinkedinCircular /></a>
                  <a href="https://github.com/ramjanmia110" aria-label="Github" className="hover:text-cyan-400 transition-colors" target="_blank"><VscGithub /></a>
                  <a href="https://mail.google.com/mail/" aria-label="Email" className="hover:text-cyan-400 transition-colors" target="_blank"><CiMail /></a>
                </Flex>
              </motion.div>
              ...
              <motion.div className="flex gap-4 flex-wrap justify-center lg:justify-start" variants={itemVariants}>
                ...
                <a
                  href="https://ramjanportfolio.vercel.app/"
